...
public class AnimationManager : MonoBehaviour
{
    ...
    public void PlayerAttackMonster()
    {
        ...
        currentPlayerTrans = bm.selectedCharacter.gameObject;
    ...
    IEnumerator PlayerAttackAnimation(Acting animName)
    {
        ...
        bm.selectedCharacter.renderer.sortingOrder = 2;
        ...
        bm.selectedCharacter.SetAnimation(Acting.Idle);
        bm.selectedCharacter.TransformPosition();
        bm.selectedCharacter.renderer.sortingOrder = 0;
    ...
    IEnumerator EnemyAttackAnimation(MonsterActing animName)
    {
        ...
        bm.selectedMonster.SetAnimation(Acting.Idle);
